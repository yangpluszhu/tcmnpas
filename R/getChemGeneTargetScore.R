getChemGeneTargetScore = function(ChemData,diseaseGeneID,ChemDataType='inchikey',QEDset=0.2,geneScore=400,geneSelectPv=0.05,targetDatabase=c('HIT','TCMID','STITCH','TCMSP','CUSTOM'),Methodnet='KATZ',IFcombine=F,Lipinski_Viosset=0,Veber_Viosset=0){
  ...
  getChemGeneFromDatabaseResult=getChemGeneFromDatabase(ChemData=ChemData,ChemDataType=ChemDataType,QEDset=QEDset,geneScore=geneScore,geneSelectPv=geneSelectPv,targetDatabase=targetDatabase,Lipinski_Viosset=Lipinski_Viosset,Veber_Viosset=Veber_Viosset)
  if (IFcombine){
