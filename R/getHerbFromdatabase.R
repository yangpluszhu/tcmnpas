getHerbFromdatabase = function(ChemData,ChemDataType='inchikey',targetDatabase=c('HIT','TCMID','STITCH','TCMSP','CUSTOM'),IFFromtargetData=F){
...
if (!IFFromtargetData){
  if (nrow(ChemData2)>0){
    ...
    subD=subD[,.(cid,chemical_name,herb,inchikey,QED_DES,Lipinski_Vios,Veber_Vios)]
