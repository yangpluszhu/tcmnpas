##' Prescription Mining 
##' @title BF_analysis 
##' @param Pdata matrix,colnames=yao,rownames=prescription$id OR csv[colname:id,herb] 
##' @param tS0.9 S0.9 value 
##' @param min_yao minimum number of herbs 
##' @param threshold_leastYao expected number of herbs 
##' @param exact combine methods 
##' @param combineSim whether to combine similar Formulas  
##' @param combine_method combine method to choose 
##' @param combine_threshold threshold to combine 
##' @param csvInput whether Pdata is a csv file 
