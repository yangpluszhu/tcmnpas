...
##' @title makeHerb_ChemNet 
##' @param NetworkData a dataframe with colnames:"herb","cid","chemical_name","geneID","score","inchikey", "smiles","database","QED_DES" 
##' @param NetworkType 'HerbChem','ChemGene',or 'HerbChemGene' 
##' @param randomtimes randomtimes for permutaion test 
##' @param INppi whether to seed in PPI network 
##' @return a list with igraph Object 
##' @export 
##' @author Yang Ming 
